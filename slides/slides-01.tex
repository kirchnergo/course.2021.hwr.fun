...
\begin{frame}[label={sec:orgf4a5596}]{Übung 2}
\begin{itemize}
...
\begin{frame}[label={sec:orgda4b8b2},fragile]{Lösung 2}
 \begin{minted}[bgcolor=mintedbg,frame=none,framesep=0pt,mathescape=true,fontsize=\scriptsize,breaklines=true,linenos=false,numbersep=5pt,gobble=0]{shell}
...
\begin{frame}[label={sec:orgf1e63f5},fragile]{git}
 \begin{itemize}
\item \href{https://git-scm.com/}{git}
\begin{minted}[bgcolor=mintedbg,frame=none,framesep=0pt,mathescape=true,fontsize=\scriptsize,breaklines=true,linenos=false,numbersep=5pt,gobble=0]{shell}
git init
